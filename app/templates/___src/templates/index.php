...
<body>
  ...
  <div class="appWrapper">
    ...
    <div class="appContent">
      ...
      <figure class="noCaption">
        <img class="lazyload"
          data-src="assets/images/_dummy/placeholder_16_10_hires.jpg"
          src="assets/images/_dummy/placeholder_16_10_lowres.jpg"
          alt="Image Alt Text">
      </figure>
      ...
      <figure>
        <img class="lazyload"
          data-src="assets/images/_dummy/placeholder_10_16_hires.jpg"
          src="assets/images/_dummy/placeholder_10_16_lowres.jpg"
          alt="Image Alt Text">
  ...
  <pre>
      ...
      <p>Cosby sweater plaid shabby chic kitsch pour-over ex. Try-hard fanny pack mumblecore cornhole cray scenester. Assumenda narwhal occupy, Blue Bottle nihil culpa fingerstache. Meggings kogi vinyl meh, food truck banh mi Etsy magna 90's duis <sup>typewriter</sup> banjo <sub>organic</sub> leggings Vice.</p>
      <hr>
      ...
      <blockquote>
        <p>Cosby sweater plaid shabby chic kitsch pour-over ex. Try-hard fanny pack mumblecore cornhole cray scenester. Assumenda narwhal occupy, Blue Bottle nihil culpa fingerstache. Meggings kogi vinyl meh, food truck banh mi Etsy magna 90's duis typewriter banjo organic leggings Vice.</p>
        <footer>
          — <cite><a href="http://www.brucelawson.co.uk/2013/on-citing-quotations-again/">Bruce Lawson</a> CEO Facebook</cite>
        </footer>
      </blockquote>
      ...
      <h3>Gist</h3>
      <script src="https://gist.github.com/davidhellmann/3df792a4bde771a792bc.js"></script>

      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis lectus metus, at posuere neque. Sed pharetra nibh eget orci convallis at Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis lectus metus, at posuere neque. Sed pharetra nibh eget orci convallis at posuere leo convallis. Sed blandit augue vitae augue scelerisque bibendum. Vivamus sit amet libero turpis, non venenatis urna. In blandit, odio convallis suscipit venenatis, ante ipsum cursus augue. posuere leo convallis. Sed blandit augue vitae augue scelerisque bibendum. Vivamus sit amet libero turpis, non venenatis urna. In blandit, odio convallis suscipit venenatis, ante ipsum cursus augue.
      </p>

      <h3>Video</h3>
      <div class="videoWrapper">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/wmIqNMH9N9w" frameborder="0" allowfullscreen></iframe>
      </div>
      ...
      <dl>
        <dt>Thesaurus</dt>
        <dd>A book for finding synonyms of other words, often alphabetical.</dd>
        <dd>A book for finding synonyms of other words, often alphabetical. Similar to a dictionary.</dd>
        <dd>A book for finding synonyms, often alphabetical. Similar to a dictionary.</dd>
        <dt>Lorem ipsum dolor sit</dt>
        <dd>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis lectus metus, at posuere neque. Sed pharetra nibh eget orci convallis at posuere leo convallis.</dd>
      </dl>
